        ...
        <div style={{padding: '20px', borderBottom: '1px solid #eee', display: 'flex', gap: '15px', flexWrap: 'wrap'}}>
          ...
          <div style={{flex: 1, minWidth: '150px', position: 'relative'}}>
            ...
            <select 
              ...
              style={{width: '100%', padding: '12px 12px 12px 45px', borderRadius: '8px', border: '1px solid #e0e0e0', fontFamily: 'Poppins', cursor: 'pointer', backgroundColor: 'white', outline: 'none', color: '#333'}}
            >
                ...
                filteredStudents.map((s) => (
                  <tr key={s.id}>
                    <td style={{paddingLeft: '24px'}}>
                        <span className="tx-id" style={{fontSize: '14px', fontWeight: '600', color: '#555'}}>{s.nis}</span>
                    </td>
                    <td>
                      <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
                        <div className="tx-icon-circle" style={{backgroundColor: '#e3f2fd', color: '#1565C0', width: '35px', height: '35px', fontSize: '14px'}}>
                          <FaUserGraduate />
                        </div>
                    ...
                    <td style={{textAlign: 'center'}}>
                        <span style={{
                            ...
                            fontSize: '12px', 
                            fontWeight: 'bold',
                            backgroundColor: s.jenis_kelamin === 'L' ? '#E3F2FD' : '#FCE4EC',
                            color: s.jenis_kelamin === 'L' ? '#1565C0' : '#C2185B'
                        }}>
                            {s.jenis_kelamin === 'L' ? 'L' : 'P'}
                        </span>
                    </td>
                    <td style={{textAlign: 'center'}}>
                        <span className="badge-status pending" style={{color: '#333', backgroundColor: '#f5f5f5', border: '1px solid #ddd'}}>{s.kelas}</span>
                    </td>
                    <td style={{textAlign: 'right', paddingRight: '30px', fontWeight: 'bold', color: '#2E7D32', fontSize: '15px'}}>
                      Rp {s.saldo ? s.saldo.toLocaleString('id-ID') : 0}
                    </td>
                    <td style={{textAlign: 'center', paddingRight: '24px'}}>
                        <button onClick={() => handleEditClick(s)} style={{border: 'none', background: '#ffb300', color: '#fff', borderRadius: '6px', padding: '6px 10px', cursor: 'pointer', boxShadow: '0 2px 5px rgba(0,0,0,0.1)'}} title="Edit Data Siswa">
                            <FaEdit />
                        </button>
                    </td>
                  </tr>
      ...
      {isModalOpen && (
        <div className="modal-overlay">
          <div className="modal-content" style={{maxWidth: '650px', width: '90%'}}>
            <h3 style={{borderBottom: '1px solid #eee', paddingBottom: '15px', marginBottom: '20px', color: '#333'}}>
            ...
            <form className="profile-form" onSubmit={handleSubmit}>
              <div style={{display: 'flex', gap: '20px', marginBottom: '15px'}}>
                ...
                <div className="form-group" style={{flex: 1}}>
                  ...
                  <input 
                    type="text" name="nama" value={formData.nama} onChange={handleInputChange} required placeholder="Nama Siswa"
                    style={{width: '100%', boxSizing: 'border-box'}} 
                  />
                </div>
              </div>
              ...
              <div style={{display: 'flex', gap: '20px', marginBottom: '15px'}}>
                <div className="form-group" style={{flex: 1}}>
                  ...
                  <select 
                    name="jenis_kelamin" value={formData.jenis_kelamin} onChange={handleInputChange} required
                    style={{width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid #e0e0e0', fontFamily: 'Poppins', backgroundColor: 'white', color: '#333', outline: 'none', boxSizing: 'border-box', cursor: 'pointer'}}
                  >
                ...
                <div className="form-group" style={{flex: 1}}>
                  <label>Kelas</label>
                  <select 
                    name="kelas" value={formData.kelas} onChange={handleInputChange} required
                    style={{width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid #e0e0e0', fontFamily: 'Poppins', backgroundColor: 'white', color: '#333', outline: 'none', boxSizing: 'border-box', cursor: 'pointer'}}
                  >
              ...
              <div className="form-group" style={{marginBottom: '15px'}}>
                  ...
                  <input type="text" name="no_hp" value={formData.no_hp} onChange={handleInputChange} placeholder="08xxxxxxxxxx" style={{width: '100%', boxSizing: 'border-box'}} />
              </div>

              <div className="form-group full-width" style={{marginBottom: '20px'}}>
                <label>Alamat</label>
                <textarea name="alamat" rows="3" value={formData.alamat} onChange={handleInputChange} style={{width: '100%', boxSizing: 'border-box', resize: 'none'}}></textarea>
              </div>
              ...
              <div className="modal-actions" style={{borderTop: '1px solid #eee', paddingTop: '20px'}}>
                ...
                <button type="submit" className="btn-submit" style={{backgroundColor: isEditing ? '#ffb300' : '#4a148c', color: isEditing ? '#333' : '#fff'}}>
